...
function App() {
  ...
  return (
    ...
    <div>
      ...
      <Router>
      <NavLink activeClassName="active" to="/checkangles">CheckAngles</NavLink>
      <NavLink activeClassName="active" to="/calculatearea">CalculateArea</NavLink>
      <NavLink activeClassName="active" to="/calculatehypotenuse">CalculateHypotenuse</NavLink>
      <NavLink activeClassName="active" to="/quiz">Take Quiz</NavLink>
